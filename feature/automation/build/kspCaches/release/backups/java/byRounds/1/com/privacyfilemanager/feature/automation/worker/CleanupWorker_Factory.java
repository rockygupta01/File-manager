...
public final class CleanupWorker_Factory {
  ...
  public static CleanupWorker_Factory create() {
    return InstanceHolder.INSTANCE;
  }

  public static CleanupWorker newInstance(Context context, WorkerParameters workerParams) {
    return new CleanupWorker(context, workerParams);
  }

  private static final class InstanceHolder {
    private static final CleanupWorker_Factory INSTANCE = new CleanupWorker_Factory();
  }
}
